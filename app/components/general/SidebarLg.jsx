...
export default function SidebarLg({handleLogout,address=null}) {
    ...
    <nav className="bg-white w-[220px] h-full flex flex-col text-base">
      ...
      <ul className="flex flex-col gap-5 items-start pl-5">
        ...
        <li className="w-full">
          <Link href={"/chat"}>
            <div className="flex items-center gap-5 lg:gap-7">
              <div className={`${segment == "chat" ? "visible" : "invisible"}`}>
                <Bullet />
              </div>
              <div className="flex gap-2">
                <svg
        ...
        <li className="w-full">
          <Link href={"/setting"}>
            <div className="flex items-center gap-5 lg:gap-7">
              <div
                className={`${segment == "setting" ? "visible" : "invisible"}`}
              >
                <Bullet />
              </div>
              <div className="flex gap-2">
        ...
        <div className="mx-4 border-2 border-[#F4F5F7] shadow-md rounded-lg mt-auto mb-10">
          <div className="flex  px-1 py-2">
            ...
            <div className="space-y-1">
              ...
              <span className="w-full block font-semibold">{address && address.fro}</span>
            </div>
          </div>
          <div className="flex bg-[#F4F5F7] px-1 py-2">
            ...
            <div className="space-y-1">
              ...
              <span className="w-full block font-semibold">{address && address.to}</span>
            </div>
          </div>
        </div>
