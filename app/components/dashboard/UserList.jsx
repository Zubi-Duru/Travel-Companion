...
export default function UserList({
  ...
  const handleConnect = async (e, id) => {
    const { data, error } = await postData(`/connect-send/${id}`, null, token);
          ...
          users.map((user, i) => {
            if (i < list) {
              const friendStatusObject = statusArray.find(
                (statusObj) => statusObj.id === user._id
              );
              ...
              return (
                ...
                >
                  <div className="flex gap-2 items-center">
                    ...
                    <div className="w-40 md:w-64 lg:w-32 xl:w-64">
                      <Link
                        ...
                        className="text-sm md:text-base lg:text-xs xl:text-base font-semibold"
                      >
                  ...
                  {isAccepted && (
                    <>
                      <span className="text-green-500 mr-2 md:scale-[1.5] inline-block">
                        ✅
                      </span>
                    </>
                  )}
