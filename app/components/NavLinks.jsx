  ...
  return (
    <>
      <div className="flex flex-col pl-4 md:pl-0 space-y-1 md:space-y-0 md:flex-row md:space-x-3 lg:space-x-6">
        <Link href="/" className="font-semibold md:font-md">Find Buddies </Link>
        <Link href="/" className="font-semibold md:font-md">Destinations </Link>
        <Link href="/" className="font-semibold md:font-md">Blog </Link>
